...
The R [\@R] and Python [\@van1995python] programming languages and the following Python packages were used for this project: pandas [\@reback2020pandas], sklearn [\@scikit-learn], shap[\@NIPS2017\_7062], tidyverse [\@tidyverse], and knitr [\@knitr]. The code used to perform the analysis and create this report can be found at: <https://github.com/UBC-MDS/seismophobia>
